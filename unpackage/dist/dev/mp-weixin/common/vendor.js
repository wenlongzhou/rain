...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"rain","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
new _vuex.default.Store({
  ...
  getters: {
    music: function music(state) {
      ...
      return "https://img.nazzzz.cn/".concat(fileName, ".mp3");
    },
    musicName: function musicName(state) {
      var musicName = [];
      if (state.bgmIndex >= 0) {
    ...
    alarm: function alarm(state) {
      return state.alarmList[state.alarmIndex];
    } },

  mutations: {
    changeRain: function changeRain(state, index) {
    ...
    changeBgm: function changeBgm(state, index) {
    ...
    changeAlarm: function changeAlarm(state, index) {
